...
Class for rendering the area conversion frame
"""
import tkinter as tk
import dictionaries.areaDict
...
class area(tk.Frame):
    ...
    def __init__(self,master):
        ...
        title = tk.Label(master,text="Area Conversion",font=self.fontLarge)
        title.grid(row=0,columnspan=2,sticky="ew",padx=20,pady=10)
        self.fromUnit = tk.StringVar()
        values = dictionaries.areaDict.area_values
    ...
    def convert(self):
        ...
        try:
            conversion = dictionaries.areaDict.area_conversions[from_unit][to_unit]
